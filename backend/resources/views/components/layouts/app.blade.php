                    ...
                    <div class="flex items-center gap-3">
                        <details class="relative md:hidden">
                            ...
                            <div class="absolute left-0 mt-2 w-72 rounded-2xl border border-slate-200 bg-white p-2 shadow-xl">
                                <a href="{{ url('/app') }}" class="block rounded-xl px-3 py-2 text-sm font-semibold text-slate-900 hover:bg-slate-50">
                                    Dashboard
                                </a>
                                <div class="mt-1 rounded-xl bg-slate-50 p-2">
                                    <div class="px-2 pb-1 text-[11px] font-semibold text-slate-500">Lançamentos</div>
                                    <a href="{{ url('/app/transactions') }}" class="block rounded-lg px-2 py-2 text-sm text-slate-900 hover:bg-white">
                                        Listar
                                    </a>
                                    <a href="{{ url('/app/transactions/new') }}" class="block rounded-lg px-2 py-2 text-sm text-slate-900 hover:bg-white">
                                        Novo lançamento
                                    </a>
                                </div>
                                <a href="{{ url('/app/goals') }}" class="mt-1 block rounded-xl px-3 py-2 text-sm font-medium text-slate-900 hover:bg-slate-50">
                                    Metas
                                </a>
                                <div class="mt-1 rounded-xl bg-slate-50 p-2">
                                    <div class="px-2 pb-1 text-[11px] font-semibold text-slate-500">Cadastros</div>
                                    <a href="{{ url('/app/categories') }}" class="block rounded-lg px-2 py-2 text-sm text-slate-900 hover:bg-white">
                                        Categorias
                                    </a>
                                    <a href="{{ url('/app/accounts') }}" class="block rounded-lg px-2 py-2 text-sm text-slate-900 hover:bg-white">
                                        Contas bancárias
                                    </a>
                                    <a href="{{ url('/app/credit-cards') }}" class="block rounded-lg px-2 py-2 text-sm text-slate-900 hover:bg-white">
                                        Cartões
                                    </a>
                                </div>
                                @if (auth()->user()?->is_admin)
                                    <div class="mt-1 rounded-xl bg-slate-50 p-2">
                                        ...
                                        <a href="{{ url('/app/admin/users') }}" class="block rounded-lg px-2 py-2 text-sm text-slate-900 hover:bg-white">
                                            Usuários
                                        </a>
                                        <a href="{{ url('/api/documentation') }}" class="block rounded-lg px-2 py-2 text-sm text-slate-900 hover:bg-white">
                                            Swagger
                                        </a>
                                    </div>
                                @endif
                        ...
                        <details class="group relative">
                            ...
                            >
                                ...
                                <div class="hidden sm:block">
                                    <div class="text-sm font-semibold leading-tight text-slate-900">{{ auth()->user()?->name ?? 'Conta' }}</div>
                                    <div class="text-xs text-slate-500">{{ auth()->user()?->email }}</div>
                                </div>
                                <span class="rounded-full border border-slate-200 bg-slate-50 px-2 py-1 text-xs font-semibold text-slate-700">
                                    {{ auth()->user()?->is_admin ? 'Admin' : 'Usuário' }}
                                </span>
                            ...
                            <div class="absolute right-0 mt-2 w-56 rounded-2xl border border-slate-200 bg-white p-2 shadow-xl">
                                <a href="{{ url('/api/documentation') }}" class="block rounded-xl px-3 py-2 text-sm text-slate-900 hover:bg-slate-50">
                                    Documentação API
                                </a>
                                @if (auth()->user()?->is_admin)
                                    <a href="{{ url('/app/admin/users') }}" class="block rounded-xl px-3 py-2 text-sm text-slate-900 hover:bg-slate-50">
                                        Admin
                                    </a>
                                @endif
            ...
            <div class="mx-auto mt-3 hidden max-w-7xl items-center gap-2 px-4 pb-3 md:flex">
                ...
                <details class="group relative">
                    ...
                    <div class="absolute left-0 mt-2 w-56 rounded-2xl border border-slate-200 bg-white p-2 shadow-xl">
                        <a href="{{ url('/app/transactions') }}" class="block rounded-xl px-3 py-2 text-sm text-slate-900 hover:bg-slate-50">
                            Listar
                        </a>
                        <a href="{{ url('/app/transactions/new') }}" class="block rounded-xl px-3 py-2 text-sm text-slate-900 hover:bg-slate-50">
                            Novo lançamento
                        </a>
                    </div>
                </details>
                ...
                <details class="group relative">
                    ...
                    <div class="absolute left-0 mt-2 w-64 rounded-2xl border border-slate-200 bg-white p-2 shadow-xl">
                        <a href="{{ url('/app/categories') }}" class="block rounded-xl px-3 py-2 text-sm text-slate-900 hover:bg-slate-50">
                            Categorias
                        </a>
                        <a href="{{ url('/app/accounts') }}" class="block rounded-xl px-3 py-2 text-sm text-slate-900 hover:bg-slate-50">
                            Contas bancárias
                        </a>
                        <a href="{{ url('/app/credit-cards') }}" class="block rounded-xl px-3 py-2 text-sm text-slate-900 hover:bg-slate-50">
                            Cartões
                        </a>
                    </div>
                </details>
