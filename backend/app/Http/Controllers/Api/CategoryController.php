...
class CategoryController extends Controller
{
    ...
    {
        return response()->json($this->categories->query()->where('user_id', $request->user()->id)->get());
    }
    ...
    public function store(Request $request)
    {
        ...
        $category = $this->categories->create(array_merge($validated, [
    ...
    public function update(Request $request, Category $category)
    {
        ...
        $category = $this->categories->update($category->id, $validated);
